    ...
    <>
      <Box>
        <Flex direction={"column"}>
          ...
          <Select placeholder="Nomoe Urut" label="Nomor Urut" data={["1","2","3","4","5"]} withAsterisk/>
          <TextInput placeholder="Dapil" label="Dapil" withAsterisk/>
          <TextInput placeholder="Cakupan Wilayah" label="Cakupan Wilayah" withAsterisk/>
          <TextInput placeholder="Komisi / AKD" label="Komisi / AKD" withAsterisk/>
          <TextInput placeholder="Tempat Lahir" label="Tempat Lahir" withAsterisk/>
          <DateInput placeholder="Tgl Lahir" label="Tgl Lahir" withAsterisk/>
          <Select data={["Laki-laki","Perempuan"]} placeholder="Jenis Kelamin" label="Jenis Kelamin" withAsterisk/>
          <TextInput placeholder="No Handphone" label="No Handphone" withAsterisk/>
