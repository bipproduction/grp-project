    ...
    fetch(api.apiListUndanganGerindraPost, {
      ...
      if (res.status === 201) {
        ...
        _postLogUser(
          ...
          "TAMBAH",
          "User menambah data list undangan gerindra"
        );
        _loadDataListUndanganGerindra(
          inputSearch,
          setListDataNew,
            ...
            <Box>
              <Flex direction={"column"}>
                <Select
                  ...
                  searchable={true}
                  {...formTambahListundangan.getInputProps(
                    "data.rencanaKunjunganGerindraId"
                  )}
                />
                ...
                <TextInput
                  ...
                  {...formTambahListundangan.getInputProps("data.nama")}
                />
