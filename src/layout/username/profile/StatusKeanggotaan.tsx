import { Box, Button, Container, Grid, Group, Input, Menu, Paper, Select, Text } from '@mantine/core'
  ...
  return (
    <>
      <Paper p={2} pt={3.5} pb={3.5} sx={{
        ...
        <Grid>
          <Grid.Col span={8}>
            <Text mt={10} ml={10}> Status Keanggotaan</Text>
          </Grid.Col>
          <Grid.Col span={4}>
      ...
      <Select radius={"md"} mt={20}
      placeholder='Status Keanggotaan' label={"**"}
        data={[
