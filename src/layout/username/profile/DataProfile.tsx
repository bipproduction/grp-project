import { Box, Button, Flex, Grid, Group, Modal, Paper, ScrollArea, Select, SimpleGrid, Text, TextInput } from '@mantine/core'
  ...
  return (
    <>
      <Paper p={2} pt={3.5} pb={3.5} sx={{
        ...
        <Grid>
          <Grid.Col span={8}>
            <Text mt={10} ml={10}> Data Profile</Text>
          </Grid.Col>
          <Grid.Col span={4}>
        ...
        <Box p={20} pl={30} pr={30} sx={{
          ...
          <ScrollArea h={450}>
            ...
            <Flex gap="md" pt={20}>
              ...
              <Box w={150}>
                <Button fullWidth color='orange.9' bg={COLOR.coklat} radius={"xl"} onClick={open} >
                  Edit KTA
                </Button>
              </Box>
              <Box w={150}>
