...
import TabAksiPrabowo from "./TabAksiGerindra";
import TabAksiGerindra from "./TabAksiGerindra";

const DataAksiGerindra = () => {
  return (
    <>
      <Paper
        p={2}
...
export default DataAksiGerindra;
