      ...
      <Box pt={20}>
        ...
        >
          ...
          <Select
            ...
            mt={10}
            radius={"md"}
            placeholder="Tingkatan Pengurus"
            data={[
              { value: "Dewan Pembina", label: "Dewan Pembina" },
              {
                value: "Dewan Pimpinan Pusat ",
                label: "Dewan Pimpinan Pusat ",
              },
              {
                value: "Dewan Pimpinan Daerah",
                label: "Dewan Pimpinan Daerah",
              },
              {
                value: "Dewan Pimpinan Cabang",
              ...
              {
                value: "Perwakilan Partai di Luar Negeri",
                label: "Perwakilan Partai di Luar Negeri",
              },
            ]}
          />
          <Select
