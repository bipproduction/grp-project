import { ActionIcon, Avatar, Box, Burger, Button, Center, Container, Flex, Grid, Group, Header, Menu, Text, ThemeIcon, TypographyStylesProvider } from '@mantine/core'
      ...
      <Header height={70} bg={COLOR.coklat}>
        <Group position="apart" sx={{ height: '100%' }}>
          ...
          <Group sx={{ height: '100%' }} spacing={0}>
            <Button variant='subtle' color='gray.0' >Home</Button>
            <Button variant='subtle' color='gray.0'>About</Button>
            <Button variant='subtle' color='gray.0'>Blog</Button>
            <Button variant='subtle' color='gray.0'>Contact Us</Button>
          </Group>
          <Group pr={20}>
            <Menu>
              <Menu.Target>
