import { Box, Button, Center, Paper, Select, SimpleGrid, Text, TextInput } from '@mantine/core'
            ...
            >
                <Box
                    ...
                    <Box>
                        ...
                        ]} radius={"md"} mt={10} placeholder="Desa" label="**" />
                        <Select data={[
                        ...
                        ]} radius={"md"} mt={10} placeholder="TPS 01 -50" label="**" />
                    </Box>
                </Box>
                <Box sx={{
                    backgroundColor: COLOR.abuabu,
                    ...
                    <Box>
                        <Text ta={'center'} fw={700} fz={20}>Jumlah DPT</Text>
                        <TextInput radius={"md"} mt={10} placeholder="Laki-Laki" label="**" />
                        <TextInput radius={"md"} mt={10} placeholder="Perempuan" label="**" />
