  ...
  return (
    ...
    <Paper p={2} pt={3.5} pb={3.5} sx={{
                ...
                background: COLOR.abuabu
                    ...
                    <Grid>
                        <Grid.Col span={8}>
                        <Text mt={10} ml={10}> Sumber Daya Partai - Data Sayap Partai</Text>
                        </Grid.Col>
                        <Grid.Col span={4}>
...
export default DataSayapPartai
