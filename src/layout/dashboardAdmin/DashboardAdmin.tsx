import { Box, Button, Center, Grid, Group, Paper, SimpleGrid, Text } from '@mantine/core'
    ...
    return (
        <>
            <Paper p={2} pt={3.5} pb={3.5} sx={{
                ...
                <Grid>
                    <Grid.Col span={8}>
                        <Text mt={10} ml={10}>Dashboard Admin</Text>
                    </Grid.Col>
                    <Grid.Col span={4}>
