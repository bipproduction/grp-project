import { BackgroundImage, Box, Button, Center, Checkbox, Container, Flex, Grid, Group, Image, Input, Menu, Paper, ScrollArea, Select, SimpleGrid, Stack, Text, TextInput, UnstyledButton } from "@mantine/core"
                        ...
                        <Grid.Col xs={6} sm={6} md={6} lg={6} xl={6}>
                            <Group>
                                ...
                                >
                                    ...
                                    <Menu width={300}>
                                    <Menu.Target>
                                    <Input radius={"md"} mt={20} component="button">Pilih Status Keanggotaan</Input>
                                ...
                                <Menu width={300}>
                                    <Menu.Target> 
                                        <Input radius={"md"} mt={20} component="button">Pilih Tingkat Pengurus</Input>
                                    </Menu.Target>
