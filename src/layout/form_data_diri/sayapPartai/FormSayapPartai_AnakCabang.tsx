...
const FormSayapPartai_AnakCabang = () => {
  return (
    <>
      <Box bg={"#25262B"}>
        <Stack>
                ...
                >
                  <Stack>
                    <Box pb={30} pt={30} pl={50} pr={50} h={800} sx={{
                      ...
                      <Menu width={300}>
                        <Menu.Target>
                          <Input radius={"md"} mt={20} component="button">Sayap Partai</Input>
                      ...
                      <Menu width={300}>
                        <Menu.Target>
                          <Input radius={"md"} mt={20} component="button">Pimpinan Anak Cabang</Input>
                        </Menu.Target>
...
export default FormSayapPartai_AnakCabang