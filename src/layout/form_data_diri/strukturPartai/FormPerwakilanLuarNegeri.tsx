...
const FormPerwakilanLuarNegeri = () => {
  return (
    <>
      <Box bg={"#25262B"}>
        <Stack>
                ...
                >
                  <Stack>
                    <Box pb={30} pt={30} pl={50} pr={50} h={800} sx={{
                      ...
                      <Menu width={300}>
                        <Menu.Target>
                          <Input radius={"md"} mt={20} component="button">Perwakilan Partai di Luar Negeri</Input>
                        </Menu.Target>
                      ...
                      ]} radius={"md"} mt={10} placeholder="Negara" label="**" />
...
export default FormPerwakilanLuarNegeri