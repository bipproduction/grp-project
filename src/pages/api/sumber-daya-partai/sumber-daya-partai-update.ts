...
const sumberDayaPartaiUpdate = async (req: NextApiRequest, res: NextApiResponse) => {
    if (req.method === "POST") {
        const body = req.body
        await client.sumberDayaPartai.update({
            ...
            data: {
                ...
                masterJabatanDewanPimpinanPusatId: body.masterJabatanDewanPimpinanPusatId,
                masterJabatanDewanPimpinanDaerahId: body.masterJabatanDewanPimpinanDaerahId,
                masterJabatanDewanPimpinanCabangId: body.masterJabatanDewanPimpinanCabangId,
                masterJabatanPimpinanAnakCabangId: body.masterJabatanPimpinanAnakCabangId,
                masterJabatanPimpinanRantingId: body.masterJabatanPimpinanRantingId,
                masterJabatanPerwakilanPartaiDiLuarNegeriId: body.masterJabatanPerwakilanPartaiDiLuarNegeriId,
