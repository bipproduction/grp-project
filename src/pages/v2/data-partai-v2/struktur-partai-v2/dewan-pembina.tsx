...
import DewanPembina2 from "../struktur-dewan-pembina2";
...
function DewanPembina() {
  ...
  const [openStrukturPem, setOpenStrukturPem] = useAtom(
    val_open_struktur_pembina
  );
  return (
    <>
      <Drawer
        opened={openStrukturPem}
        onClose={() => setOpenStrukturPem(false)}
        size={490}
      >
        <DewanPembina2 />
      </Drawer>
