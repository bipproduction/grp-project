...
import { randomId, useHash, useShallowEffect } from "@mantine/hooks";
import { toNumber } from "lodash";
import moment from "moment";
import { useState } from "react";
import toast from "react-simple-toasts";

export default function CobaUseHash() {
  ...
  const cekUsia = (val: any) => {
    ...
    // setValue({
    //     ...value,
    //     tanggal: moment(val).format("YYYY-MM-DD")
    // })
  }
